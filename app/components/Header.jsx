  ...
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      >
        ...
        high-performance web applications. I specialize in the MERN stack, Next.js, 
        and TypeScript, and currently work as an SDE 1 at PsiBorg Technologies. 
        I love turning complex problems into clean, efficient, and user-friendly solutions.
      </motion.p>
